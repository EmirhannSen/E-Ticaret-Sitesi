...
function kategoriListele($db, $kategori_ust = 0, $seviye = 0, $selected = 0) {
    ...
    while ($kategoricek = $kategorisor->fetch(PDO::FETCH_ASSOC)) {
        $isSelected = $kategoricek['kategori_id'] == $selected ? 'selected' : '';
        echo '<option value="' . $kategoricek['kategori_id'] . '" ' . $isSelected . '>' . str_repeat('- ', $seviye) . $kategoricek['kategori_ad'] . '</option>';
        kategoriListele($db, $kategoricek['kategori_id'], $seviye + 1, $selected);
    }
}
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" name="kategori_ust">
                    <option value="0" <?php echo $kategoricek['kategori_ust'] == 0 ? 'selected' : ''; ?>>Ana Kategori</option>
                    <?php kategoriListele($db, 0, 0, $kategoricek['kategori_ust']); ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="kategori-ad" name="kategori_ad" value="<?php echo $kategoricek['kategori_ad']; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="kategori-sira" name="kategori_sira" value="<?php echo $kategoricek['kategori_sira']; ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
